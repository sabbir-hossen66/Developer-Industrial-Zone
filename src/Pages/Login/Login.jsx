...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    signIn(email, password)
      ...
      .catch(error => {
        setLoginError('error.messege', error.messege)
      })
    ...
    <div className="my-10 max-w-2xl mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-white">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <div className="space-y-1 text-sm">
          ...
          <input type="password" name="password" id="password" placeholder="password" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-default-600" required />
