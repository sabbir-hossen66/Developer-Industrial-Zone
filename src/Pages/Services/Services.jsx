...
const UpdateProfile = () => {
  ...
  <div className="hero-content flex-col">
    <div className="text-center lg:text-left">
      <h1 data-aos='fade-right' className="text-4xl my-3 font-bold">Update Your Profile</h1>
    </div>
    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100   py-6">
      <form onSubmit={handleUpdateProfile} className="card-body">
        <div className="form-control">
          <label className="label">
            <span data-aos='fade-left' className="label-text">Name</span>
          </label>
          <input data-aos='fade-left' type="text" name="name" placeholder="Name" className="input input-bordered" required />
        </div>
        <div className="form-control">
          <label className="label">
            <span data-aos='fade-right' className="label-text">Photo URL</span>
          </label>
          <input data-aos='fade-right' type="text" name="photo" placeholder="Photo URL" className="input input-bordered" required />
        </div>
        <div data-aos='fade-left' className="form-control mt-6">
        ...
        <div className=" mb-0 lg:mb-10 mt-0 md:mt-28 lg:mt-28">
           <div className="flex flex-col justify-center shadow-2xl max-w-xs p-12 rounded-xl sm:px-12 bg-white pb-20 mx-auto dark:text-gray-800">
  <img data-aos='fade-right' src={user?.photoURL} alt="" className="w-32 h-32 mx-auto rounded-full  aspect-square" />
  <div className="space-y-4 text-center divide-y dark:divide-gray-300">
    ...
    <div data-aos='fade-up' className="flex justify-center pt-2 space-x-4 align-center">
