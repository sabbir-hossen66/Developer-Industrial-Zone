        ...
        <div className="container px-6 py-12 mx-auto">
          <div className="grid items-center gap-4 xl:grid-cols-5">
            <div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
              <h2 className="text-4xl font-bold">Forging Tomorrows Success Through Todays Innovation.</h2>
              <p className="text-white">At Dev Industrial_Zone LTD we are committed to pushing the boundaries of industrial excellence. With decades of experience in the field, our company has established itself as a leader in delivering cutting-edge solutions to meet the evolving needs of the industrial sector.</p>
            </div>
                  ...
                  <div className="p-6 bg-white rounded shadow-md text-black">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-white">ADV of Company DIZ.</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-6 bg-white rounded shadow-md text-black">
                ...
                <div className="grid content-center gap-4">
                  <div className="p-6 bg-white rounded shadow-md text-black">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        <p className="text-lg font-semibold">Jon</p>
                        <p className="text-sm text-white">COO of Company DIZ.</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-6 bg-white rounded shadow-md text-black">
                    ...
                    <div className="flex items-center mt-4 space-x-4">
                      ...
                      <div>
                        <p className="text-lg font-semibold">Jesika</p>
                        <p className="text-sm text-white">CEO of Company DIZ.</p>
                      </div>
                    </div>
                  </div>
                </div>
