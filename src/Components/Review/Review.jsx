      ...
      <div data-aos="zoom-out-up" className="grid sm:grid-cols-1 lg:grid-cols-3 gap-4 rounded-md py-10 ">
        ...
        <div className="container flex  flex-col  lg:w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
          ...
          <div className="p-4 space-y-2 text-sm dark:text-gray-600">
            <p>I have had the pleasure of working with Stellar Manufacturing Solutions on several projects, and I must say, they truly live up to their name</p>
            <p>From start to finish, their professionalism and dedication to quality have been exceptional.</p>
          </div>
        </div>
